...
class AgencyPermission(AutoNameEnum):
    ...
    ADD_RED_FLAG_ALL_CSO_PROFILES = auto()
    ADD_FLAG_OBSERVATION_ALL_CSO_PROFILES = auto()  # All flags except Red
    ADD_FLAG_OBSERVATION_COUNTRY_CSO_PROFILES = auto()  # All flags except Red, users country must match CSOs country

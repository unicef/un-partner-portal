...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/partner-applications/$', PartnerEOIApplicationCreateAPIView.as_view(), name="partner-applications"),
    url(r'^(?P<pk>\d+)/partner-application/$', PartnerEOIApplicationRetrieveAPIView.as_view(), name="partner-application"),
    ...
    url(r'^applications/unsolicited/$', PartnerApplicationUnsolicitedListCreateAPIView.as_view(), name="applications-unsolicited"),

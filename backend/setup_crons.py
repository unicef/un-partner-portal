...
if __name__ == '__main__':
    ...
    daily_notifications_job = next(cron.find_comment('send_daily_notifications'), None) or cron.new(
        f'python /code/unpp_api/manage.py send_daily_notifications', comment='send_daily_notifications'
    )
    ...
    weekly_notifications_job = next(cron.find_comment('send_weekly_notifications'), None) or cron.new(
        f'python /code/unpp_api/manage.py send_weekly_notifications', comment='send_weekly_notifications'
    )

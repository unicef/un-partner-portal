...
const messages = {
  title: 'Are you sure you want to delete this CFEI?',
  info: 'Please confirm that you want to delete this CFEI?',
  publish: 'delete',
};
...
class DeleteCfeiModal extends Component {
  constructor(props) {
    super(props);
...
const connected = connect(mapStateToProps, mapDispatchToProps)(DeleteCfeiModal);

export default withStyles(styleSheet, { name: 'DeleteCfeiModal' })(connected);

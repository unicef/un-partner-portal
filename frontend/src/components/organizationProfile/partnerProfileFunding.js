...
const styleSheet = createStyleSheet('partnerProfileFunding', theme => ({
  container: {
    // position: 'absolute',
    // height: '100%'
 ...
 */
const partnerProfileFunding = (props, context) => {
  ...
  partnerProfileFunding.contextTypes = {muiTheme: PropTypes.object.isRequired};

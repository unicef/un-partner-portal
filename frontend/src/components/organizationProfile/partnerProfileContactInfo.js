...
const styleSheet = createStyleSheet('partnerProfileContactInfo', theme => ({
  container: {
    // position: 'absolute',
    // height: '100%'
 ...
 */
const partnerProfileContactInfo = (props, context) => {
  ...
  partnerProfileContactInfo.contextTypes = {muiTheme: PropTypes.object.isRequired};

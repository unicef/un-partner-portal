...
const styleSheet = createStyleSheet('partnerProfileMandate', theme => ({
  container: {
    // position: 'absolute',
    // height: '100%'
 ...
 */
const partnerProfileMandate = (props, context) => {
  ...
  partnerProfileMandate.contextTypes = {muiTheme: PropTypes.object.isRequired};

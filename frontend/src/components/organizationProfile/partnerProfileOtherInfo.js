...
const styleSheet = createStyleSheet('partnerProfileOtherInfo', theme => ({
  container: {
    // position: 'absolute',
    // height: '100%'
 ...
 */
const partnerProfileOtherInfo = (props, context) => {
  ...
  partnerProfileOtherInfo.contextTypes = {muiTheme: PropTypes.object.isRequired};

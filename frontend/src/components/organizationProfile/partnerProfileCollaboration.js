...
const styleSheet = createStyleSheet('partnerProfileCollaboration', theme => ({
  container: {
    // position: 'absolute',
    // height: '100%'
 ...
 */
const partnerProfileCollaboration = (props, context) => {
  ...
  partnerProfileCollaboration.contextTypes = {muiTheme: PropTypes.object.isRequired};
